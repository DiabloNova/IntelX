    ...
    <section className="relative isolate overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center py-14 sm:py-20">
          ...
          <h1 className="mt-3 text-center text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl text-green-400">
            <span className="block">HIGH-IMPACT</span>
            <span className="block text-green-300 drop-shadow-[0_0_20px_rgba(34,197,94,0.35)]">3D ANIMATION</span>
