...
const defaultContent: FooterContent = {
  ...
  copyright: "© 2025 — Intel X International",
}
              ...
              <div className="relative rounded-[28px] liquid-glass p-2 shadow-2xl">
                <div className="relative aspect-[9/19] w-full overflow-hidden rounded-2xl bg-black">
                  ...
                  <LazyVideo
                    ...
                    muted={true}
                    playsInline={true}
                    aria-label="Intel X app preview - approvals made easy"
                  />
                  {/* On-screen content */}
          ...
          <div className="grid gap-8 md:grid-cols-[1.2fr_1fr_1fr]">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <Image src="/images/intelxlogo.png" alt="Intel X logo" width={32} height={32} className="h-8 w-8" />
                <span className="text-lg font-medium text-white">+</span>
                <Image
                  src="/images/1df3763f36633f4a448369e6a6b6d60e.png"
                  alt="UniCat logo"
                  width={32}
                  height={32}
                  className="h-8 w-8"
                ...
                <ul className="space-y-2 text-sm text-neutral-300">
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      aria-label="Follow Intel X on Twitter"
                    >
                      X/Twitter
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Subscribe to Intel X on YouTube"
                    >
                      YouTube
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Follow Intel X on Instagram"
                    >
                      Instagram
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Follow Intel X on Threads"
                    >
                      Threads
                    </a>
                  </li>
